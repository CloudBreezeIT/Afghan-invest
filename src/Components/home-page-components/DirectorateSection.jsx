      ...
      <div className='w-full md:w-[1150px] m-auto pl-8 md:pl-0 '>
        <div className="flex flex-col md:flex-row justify-between gap-10 py-10">
            ...
            <div className="flex flex-col items-start justify-center">
                <p className='text-yellow-500 rounded font-semibold text-2xl bg-gray-800 px-20 py-3 ml-5 md:ml-0'>{t("directorateSection-msg")}</p>
                ...
                <p className='text-xl font-semibold my-[2px] uppercase text-yellow-700'>{t("directorateSection-name")}</p>
                </div>
                <p className='w-[600px] px-4 md:px-0'>
                <span className=''>{t("directorateSection-greeting")}</span> <br />
                <span>{t("directorateSection-desc")}</span>
                <span><Link className='text-yellow-500 font-semibold'>{t("directorateSection-btn")}</Link></span>
                </p>
